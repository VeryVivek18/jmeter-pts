...
RUN curl -L ${JMETER_PLUGINS_DOWNLOAD_URL}/jmeter-plugins-perfmon/2.0/jmeter-plugins-perfmon-2.0.jar -o ${JMETER_PLUGINS_FOLDER}/jmeter-plugins-perfmon-2.0.jar
RUN curl -L ${JMETER_PLUGINS_DOWNLOAD_URL}/jmeter-plugins-emulators/0.2/jmeter-plugins-emulators-0.2.jar -o ${JMETER_PLUGINS_FOLDER}/jmeter-plugins-emulators-0.2.jar
